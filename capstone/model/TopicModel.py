...
class TopicModel(ModelInterface):
    ...
    def pre_process(self):
        ...
        bigram = gensim.models.Phrases(self._norm_documents, min_count=20, threshold=20, delimiter=b'_') # higher threshold fewer phrases.
        ...
        self._dictionary = gensim.corpora.Dictionary(norm_corpus_bigrams)
        ...
        #Create BOW
        self._bow_corpus = [self._dictionary.doc2bow(text) for text in norm_corpus_bigrams]
